  ...
  return (
    <div className="mt-8 mx-auto max-w-md">
      ...
      <form
        ...
        className="grid grid-cols-2 gap-4 bg-primary rounded-md shadow-lg shadow-black/60 p-6  border-shadow"
      >
      ...
      {plantList.length > 0 ? (
        <>
          <h2 className="text-center bg-primary text-text text-lg font-semibold mt-4 px-3 py-1 rounded-sm shadow-md shadow-black/60 mb-4">
            Your Plants
          </h2>
